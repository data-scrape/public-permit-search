...
**Permit Search** — Public Permit Search - Normalize publicly available permit records for market research workflows

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/public-permit-search?style=social)
...
>
> **Search intent:** collect public Permits data for research, enrichment, and monitoring workflows. Related topics: public records, permit data, business research, python, data extraction.

## What this project is for

`public-permit-search` is an implementation-focused Python project for collecting public Permits data. It is designed around one practical job: turn a query such as **"restaurants in Seattle"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/public-permit-search.git
cd public-permit-search
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Permits", "category": "Public Records Scrapers"}
  }
}
```
